...
class AddressACHBillingInfoPage extends Component {
  state = {
    agreedTNC: false,
    isLoading: false,
  };
          ...
          <div style={{ display: "flex", justifyContainer: "flex-start" }}>
            ...
            >
              ...
              <span style={{ fontSize: "12px", fontWeight: "bold" }}>
                {"XXXX-XXXX-XXXX-" + iframeACHResponse.accountNumber}
              </span>
            </div>
          </div>
          <div style={{ display: "flex", justifyContainer: "flex-start" }}>
            ...
            >
              Routing Number:{" "}
              <span style={{ fontSize: "12px", fontWeight: "bold" }}>
                {iframeACHResponse.routingNumber ? '*****' + iframeACHResponse.routingNumber.substring(5): ''}
              </span>
            </div>
          </div>
          <div style={{ display: "flex", justifyContainer: "flex-start" }}>
